                ...
                <div class="col-12 col-sm-12 col-lg-12">
                    <div class="card">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Dipinjam</a>
                            </li>
                            <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Approve Pinjaman</a>
                            </li>
                        </ul>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Aprove Peminjaman Buku</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <form action="{{url('apporve-peminjaman')}}" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name = "jml_peminjaman" class="form-control" required value = "{{$item->jml_peminjaman}}">
                        </div>
                        <div class="form-group">
                            <label for="">Batas Pengembalian</label>
                            <input type="date" name = "batas_pengembalian" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Status Peminjaman</label>
                            <select name="status_peminjaman" class="form-control" required id="">
