            ...
            <div class="col-md-12 col-sm-12">
                @if (session()->has('err_message'))
                    <div class="alert alert-danger alert-dismissible" role="alert" auto-close="120">
                        <strong>Gagagl! </strong>{{ session()->get('err_message') }}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mt-3">
                            <label for="">Deskripsi</label>                             <textarea name="deskripsi_webiner" id="" cols="30" rows="10" value = "{{$data['detail']->deskripsi_webiner}}" class="form-control" readonly>{{$data['detail']->deskripsi_webiner}}</textarea>
                        </div>

                        <div class="text-right mt-5">
                            <a href="{{url('cetak-sertifikat-peserta/'.$data['detail']->id_webiner)}}" target = "_BLANK" class="btn btn-primary">Cetak Sertifikat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form action="{{url('insert-materi')}}" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name = "id_webiner" value = "{{$data['detail']->nama_webiner}}">
